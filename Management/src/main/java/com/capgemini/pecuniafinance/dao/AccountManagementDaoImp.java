...
public class AccountManagementDaoImp implements IAccountManagementDao{
	 ...
	 static Map<Long,AccountDetails> map=new HashMap<Long,AccountDetails>();
       {
       map.put(789307801700l,new AccountDetails("pritam",7893078017l,789307801700l,"Savings","3-77/2a","srinagar","hyderabad","Telangana","India",502516,9005.00));
       map.put(944094835101l,new AccountDetails("shanthi",9553017206l,944094835101l,"Savings","3-73/2a","karimnagar","hyderabad","Telangana","India",502512,5045.00));
       map.put(944094835102l,new AccountDetails("srividya",9553017207l,944094835102l,"current","3-72/2a","gandhi nagar","hyderabad","Telangana","India",502519,7026.00));
       map.put(944094835103l,new AccountDetails("nikshitha",9553017208l,944094835103l,"Savings","3-71/2a","dn colony","hyderabad","Telangana","India",502513,6005.00));
       map.put(944094835104l,new AccountDetails("ChVenu",9553017209l,944094835104l,"current","3-75/2a","vishnupur","hyderabad","Telangana","India",502515,15005.00));
       map.put(944094835105l,new AccountDetails("Chikki",9553017200l,944094835105l,"current","3-75/2a","vishnupur","hyderabad","Telangana","India",502515,15005.00));
       }
