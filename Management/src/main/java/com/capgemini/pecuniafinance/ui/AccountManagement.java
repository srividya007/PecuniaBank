	...
	public static void main(String[] args) {
		...
		try {
			while (true) {
				...
				boolean flags = serviceobj.checkAccNumber(accNumber); // checking
				boolean flag1 = serviceobj.validAccountNumber(account); // validation
				if (flag1 == true && flags == true) {
					...
					case 1:
						while (true) {
							...
							System.out.println("2.Update Customer Mobile Number");
							...
							case 3:
								...
								boolean flag3 = serviceobj.validAddress(address1, address2, city, state, country,
										pincode);
								if (flag3 == true) {
									...
									if (flag6 = true) {
										...
										System.err.println("Please enter valid address.....\n"
												+ "address must contain numbers,alphabets,special characters{/,-}");
									}
								} else {
									System.err.println("Please enter valid address.....");
								}
